...
namespace PL.MVC.IOBalance.Controllers
{
    public partial class AuthenticationController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public AuthenticationController Actions { get { return IOBALANCEMVC.Authentication; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Index = "~/Views/Authentication/Index.cshtml";
            public readonly string Login = "~/Views/Authentication/Login.cshtml";
            public readonly string UnAuthorized = "~/Views/Authentication/UnAuthorized.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AuthenticationController : PL.MVC.IOBalance.Controllers.AuthenticationController
    {
        ...
        [NonAction]
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, PL.Business.Dto.IOBalance.AuthenticationDto dto);

        [NonAction]
        public override System.Web.Mvc.ActionResult Login(PL.Business.Dto.IOBalance.AuthenticationDto dto)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "dto", dto);
            LoginOverride(callInfo, dto);
            return callInfo;
        }
