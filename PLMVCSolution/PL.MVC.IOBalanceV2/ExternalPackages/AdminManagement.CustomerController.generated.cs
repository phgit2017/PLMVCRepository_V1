...
namespace PL.MVC.IOBalanceV2.Areas.AdminManagement.Controllers
{
    public partial class CustomerController
    {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.ActionResult ActivateDetails()
        {
            return new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ActivateDetails);
        }

        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public CustomerController Actions { get { return IOBALANCEMVCV2.AdminManagement.Customer; } }
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string ActivateDetails = "ActivateDetails";
        }
        ...
        public class ActionNameConstants
        {
            ...
            public const string ActivateDetails = "ActivateDetails";
        }
        ...
        static readonly ActionParamsClass_ActivateDetails s_params_ActivateDetails = new ActionParamsClass_ActivateDetails();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_ActivateDetails ActivateDetailsParams { get { return s_params_ActivateDetails; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_ActivateDetails
        {
            public readonly string dto = "dto";
        }
        ...
        public class ViewsClass
        {
            ...
            public readonly string _Details = "~/Areas/AdminManagement/Views/Customer/_Details.cshtml";
            public readonly string _Edit = "~/Areas/AdminManagement/Views/Customer/_Edit.cshtml";
            public readonly string _List = "~/Areas/AdminManagement/Views/Customer/_List.cshtml";
            public readonly string _New = "~/Areas/AdminManagement/Views/Customer/_New.cshtml";
            public readonly string _Search = "~/Areas/AdminManagement/Views/Customer/_Search.cshtml";
            public readonly string Index = "~/Areas/AdminManagement/Views/Customer/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CustomerController : PL.MVC.IOBalanceV2.Areas.AdminManagement.Controllers.CustomerController
    {
        ...
        [NonAction]
        partial void GetDetailsOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Kendo.Mvc.UI.DataSourceRequest request, PL.MVC.IOBalanceV2.Areas.AdminManagement.Models.CustomerSearchModel searchModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult GetDetails(Kendo.Mvc.UI.DataSourceRequest request, PL.MVC.IOBalanceV2.Areas.AdminManagement.Models.CustomerSearchModel searchModel)
        {
        ...
        [NonAction]
        partial void SaveDetailsOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, PL.Business.Dto.IOBalanceV2.CustomerDto dto);

        [NonAction]
        public override System.Web.Mvc.ActionResult SaveDetails(PL.Business.Dto.IOBalanceV2.CustomerDto dto)
        {
        ...
        [NonAction]
        partial void UpdateDetailsOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, PL.Business.Dto.IOBalanceV2.CustomerDto dto);

        [NonAction]
        public override System.Web.Mvc.ActionResult UpdateDetails(PL.Business.Dto.IOBalanceV2.CustomerDto dto)
        {
        ...
        [NonAction]
        partial void ActivateDetailsOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, PL.Business.Dto.IOBalanceV2.CustomerDto dto);

        [NonAction]
        public override System.Web.Mvc.ActionResult ActivateDetails(PL.Business.Dto.IOBalanceV2.CustomerDto dto)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.ActivateDetails);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "dto", dto);
            ActivateDetailsOverride(callInfo, dto);
            return callInfo;
        }
