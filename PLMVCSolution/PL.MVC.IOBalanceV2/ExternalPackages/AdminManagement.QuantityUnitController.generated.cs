...
{
    public partial class QuantityUnitController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected QuantityUnitController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public QuantityUnitController Actions { get { return IOBALANCEMVCV2.AdminManagement.QuantityUnit; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "AdminManagement";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "QuantityUnit";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "QuantityUnit";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string _Details = "~/Areas/AdminManagement/Views/QuantityUnit/_Details.cshtml";
            public readonly string _Edit = "~/Areas/AdminManagement/Views/QuantityUnit/_Edit.cshtml";
            public readonly string _List = "~/Areas/AdminManagement/Views/QuantityUnit/_List.cshtml";
            public readonly string _New = "~/Areas/AdminManagement/Views/QuantityUnit/_New.cshtml";
            public readonly string _Search = "~/Areas/AdminManagement/Views/QuantityUnit/_Search.cshtml";
            public readonly string index = "~/Areas/AdminManagement/Views/QuantityUnit/index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_QuantityUnitController : PL.MVC.IOBalanceV2.Areas.AdminManagement.Controllers.QuantityUnitController
    {
        public T4MVC_QuantityUnitController() : base(Dummy.Instance) { }
        ...
        [NonAction]
        partial void GetDetailsOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Kendo.Mvc.UI.DataSourceRequest request, PL.MVC.IOBalanceV2.Areas.AdminManagement.Models.QuantityUnitSearchModel searchModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult GetDetails(Kendo.Mvc.UI.DataSourceRequest request, PL.MVC.IOBalanceV2.Areas.AdminManagement.Models.QuantityUnitSearchModel searchModel)
        {
        ...
        [NonAction]
        partial void SaveDetailsOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, PL.Business.Dto.IOBalanceV2.QuantityUnitDto dto);

        [NonAction]
        public override System.Web.Mvc.ActionResult SaveDetails(PL.Business.Dto.IOBalanceV2.QuantityUnitDto dto)
        {
        ...
        [NonAction]
        partial void UpdateDetailsOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, PL.Business.Dto.IOBalanceV2.QuantityUnitDto dto);

        [NonAction]
        public override System.Web.Mvc.ActionResult UpdateDetails(PL.Business.Dto.IOBalanceV2.QuantityUnitDto dto)
        {
