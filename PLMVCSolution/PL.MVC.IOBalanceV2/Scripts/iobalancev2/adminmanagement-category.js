var ADMINMANAGEMENTCATEGORY = (function () {
    ...
    var _doSearchDetails = function () {
        var $gv = $("#gvCategory").data('kendoGrid'), $frm = $('#frmSearch');
    ...
    var _doInitializeElements = function () {
        ...
        $('body').on('shown.bs.modal', '#mdledit', function () {
            ...
            $('#frmEdit #hdfCategoryId').val($this.data('category-id'));
            $('#frmEdit #CategoryName').val($this.data('category-name'));
        });
...
$(document).ready(function () {
    ...
    $gv.kGridResizeHeight({
        height: ADMINMANAGEMENTCATEGORY._variables.gvHeight,
