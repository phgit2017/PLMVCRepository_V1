...
{
    public class IOBalanceRepository <T> : IIOBalanceRepository<T> where T : class
    {
        protected IIOBalanceDBContext Db;

        public IOBalanceRepository(IIOBalanceDBContext dataContext)
        {
            Db = dataContext;
        }
