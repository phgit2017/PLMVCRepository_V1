...
{
    public class ChainSawRepository <T> : IIOBalanceRepository<T> where T : class
    {
        protected IChainSawDBContext Db;

        public ChainSawRepository(IChainSawDBContext dataContext)
        {
            Db = dataContext;
        }
